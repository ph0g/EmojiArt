...
// we name this index(matching:) instead of fisrtIndex(matching:)
...
extension Character {
    var isEmoji: Bool {
        ...
        // (the start of the "msicellaneous items" section)
...
// imgurl is a "well known" key that can be embedded in a url that says that the actual image url is
